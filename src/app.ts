...
// A função express() devolve um objeto que representa o
//servidor da aplicação
const app: Express = express();
// Define a porta onde o servidor ficará disponível
// Neste caso, o servidor poderá ser acessado pela porta
8082
const PORT: number = 8082;
// Inicializa o servidor utilizando a porta definida
// O método listen() faz o servidor começar a "escutar"
//requisições HTTP
app.listen(PORT, () => {
